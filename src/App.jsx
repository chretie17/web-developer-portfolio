...
import profilePic from './assets/TC white-min.png';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="bg-gray-50 p-6 rounded-3xl space-y-4 shadow-xl">
                <div className="flex items-center gap-3 text-blue-900 hover:text-blue-700 transition-colors">
                  ...
                  <a href="tel:+250788841213" className="text-lg font-medium">+250 788 841 213</a>
                </div>
                <div className="flex items-center gap-3 text-blue-900 hover:text-blue-700 transition-colors">
                  <PhoneIcon className="w-5 h-5 flex-shrink-0" />
                  <a href="tel:+250739003950" className="text-lg font-medium">+250 739 003 950</a>
                </div>
                <div className="flex items-center gap-3 text-blue-900 hover:text-blue-700 transition-colors">
                  <MailIcon className="w-5 h-5 flex-shrink-0" />
                  <a href="mailto:turachretien@gmail.com" className="text-lg font-medium">turachretien@gmail.com</a>
                </div>
              </div>
            ...
            {[1, 2, 3].map((_, index) => (
              <div key={index} className="bg-gray-50 p-8 rounded-3xl shadow-xl">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-blue-900">Rene Gasana</h4>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-3xl flex flex-col items-center text-center shadow-xl">
              ...
              <p className="text-blue-800">turachretien@gmail.com</p>
            </div>
            <div className="bg-white p-6 rounded-3xl flex flex-col items-center text-center shadow-xl">
      ...
      <footer className="py-12 text-center text-blue-800 border-t border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-xl flex items-center justify-center gap-2">
            Crafted with <SparklesIcon className="w-6 h-6 text-blue-900" /> by Turashimye Chretien © {new Date().getFullYear()}
          </p>
        </div>
      </footer>
    </div>
